...
public class BubbleActivityMultiple extends
	...
	public void testRun() {
		...
		assertEquals("Bubble hasn't appeared", 1, solo.getCurrentViews(BubbleActivity.BubbleView.class).size());
		...
		// Assert that a bubble was displayed 
		assertEquals("Second bubble hasn't appeared", 2, solo.getCurrentViews(BubbleActivity.BubbleView.class).size());
